...
| 2 — Остальные 13 WS | ✅ done | 2026-04-30 | aster/gate/mexc/whitebit/bingx/htx/kraken/kucoin/bitget+spot/hyperliquid/paradex/lighter/backpack — все 17 пишут books.<ex>.json. Поправлены 4 venue-specific quirks (Gate accuracy "0", Paradex depth=15+freq=100ms+inserts/deletes/updates, Lighter colon/slash channel, Backpack REST-seed delta merge). |
| 3 — Funding WS | ⬜ | — | — |
| 4 — Merger + Redis | ⬜ | — | — |
| 5 — Broadcast (опц.) | ⬜ | — | — |
| 6 — Rollout | ⬜ | — | — |
